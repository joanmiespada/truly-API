...
use lib_util_jwt::jwt::create_jwt;
                 ...
                 Some(payload) => {
                    ...
                    match result {
                        ...
                        Ok(log_inf) => {
                            ...
                            let token_secret = config.env_vars().jwt_token_base().unwrap();
                            let exp_hours =  config.env_vars().jwt_token_time_exp_hours().unwrap().parse::<i64>().unwrap();
